...
namespace LogTerminal
{
    public partial class FrmTerminal : Form
    {
        ...
        private FormDataCapture _dataCaptureInstance;
        ...
        public void InitializeChildForms()
        {
            ...
            // DATA CAPTURE
            if (_dataCaptureInstance == null || _dataCaptureInstance.IsDisposed)
                _dataCaptureInstance = new FormDataCapture(this, _sharedData, TraceAppMsg, ConnectState, DataCaptureActive, TxData);
            _myForms.InitializeSingleInstanceForm(this, _dataCaptureInstance);
        ...
        public void EnableControls()
        {
            ...
            _myUi.InvokeIfRequired(_dataCaptureInstance, () => { _dataCaptureInstance.FormEnable = _serialConnect.IsOpen; });
        ...
        public void DisableControls()
        {
            ...
            _myUi.InvokeIfRequired(_dataCaptureInstance, () => { _dataCaptureInstance.FormEnable = false; });
        ...
        public void SerialAutomateActive()
        {
            ...
            _myUi.InvokeIfRequired(_dataCaptureInstance, () => { _dataCaptureInstance.CaptureEnableCheckbox.Checked = false; }); // Force cancel incase in trigger mode
        }
        ...
        public void InitializeCOMPortValues()
        {
            ...
            _myUi.InvokeIfRequired(_serialSettingsInstance, () =>
            {
                ...
                foreach (string s in SerialPort.GetPortNames())
                {
                   ...
                   if (!_serialConnect.IsPortAvailable(s))
                    {
#if DEBUG
                        Trace.WriteLine($"Unavaliable : {s} is currently being used by another application");
#endif
                    }
                }
        ...
        // Need to handle occupied ports better
        public void Connect()
        {
            ...
            tsslConnectionStatus.Text = $"Connected : {_serialSettingsInstance.ExtCmbPortName.Text} : {_serialSettingsInstance.ExtCmbBaudRate.Text} ";
        ...
        public void RxData(object sender, SerialDataEventArgs e)
        {
            ...
            {
                if (_serialTestChallengeInstance.ChallengeEnableCheckbox.Checked || _dataCaptureInstance.CaptureEnableCheckbox.Checked)
                {
        ...
        private void BtnLogWindow_Click(object sender, EventArgs e)
        {
            ...
            if (_serialLogWindowInstance.WindowState == FormWindowState.Minimized)
                _serialLogWindowInstance.WindowState = FormWindowState.Normal;
        }
        ...
        { 
            ...
            if (_serialSettingsInstance.WindowState == FormWindowState.Minimized)
                _serialSettingsInstance.WindowState = FormWindowState.Normal;
        }
        ...
        private void BtnSideTesting_Click(object sender, EventArgs e)
        {
            ...
            if (_serialTestChallengeInstance.WindowState == FormWindowState.Minimized)
                _serialTestChallengeInstance.WindowState = FormWindowState.Normal;
        }

        private void BtnSideCapture_Click(object sender, EventArgs e)
        {
            if (_dataCaptureInstance == null || _dataCaptureInstance.IsDisposed)
                _dataCaptureInstance = new FormDataCapture(this, _sharedData, TraceAppMsg, ConnectState, DataCaptureActive, TxData);
            _myForms.OpenSingleInstanceForm(this, _dataCaptureInstance);

            if (_dataCaptureInstance.WindowState == FormWindowState.Minimized)
                _dataCaptureInstance.WindowState = FormWindowState.Normal;
        }
        ...
        private void BtnSideUtilities_Click(object sender, EventArgs e)
        {
            ...
            if (_serialUtilitiesInstance.WindowState == FormWindowState.Minimized)
                _serialUtilitiesInstance.WindowState = FormWindowState.Normal;
        }
        ...
        private void BtnSideInfo_Click(object sender, EventArgs e)
        {
            ...
            if (_serialInfoInstance.WindowState == FormWindowState.Minimized)
                _serialInfoInstance.WindowState = FormWindowState.Normal;
        }
        ...
        private void BtnTestHide_Click(object sender, EventArgs e)
        {
            ...
            {
                if (childForm.Visible && !childForm.IsDisposed) childForm.WindowState = FormWindowState.Minimized;
            }
        }
